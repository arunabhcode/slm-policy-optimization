...
@dataclass
class GTPOScriptArguments(ScriptArguments):
    """
    Script arguments for the GTPO training script.
    ...
    max_prompt_len: int = field(
        default=512,
        metadata={"help": "Maximum length for prompts"},
    )
...
if __name__ == "__main__":
    parser = TrlParser((GTPOScriptArguments, GRPOConfig, ModelConfig))
